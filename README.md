game:GetService("ReplicatedStorage"):WaitForChild("DefaultChatSystemChatEvents").SayMessageRequest:FireServer("ok so which one of yall ffzz my mom","All")
...
end) -- dont use ws and this script isnt owned by me
